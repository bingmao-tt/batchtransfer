...
class Chain:
    ...
    :member
        chain: Chain name
        displayName : Displayname of chain
    ...
    def print_object(self, format_data=""):
        ...
        PrintBasic.print_basic(
            self.displayName, format_data + "DisplayName of Chain")
        PrintBasic.print_basic(self.baseChain, format_data + "Base Chain")
        PrintBasic.print_basic(self.baseChainProtocol,
                               format_data + "Base Chain Protocol")
        ...
        PrintBasic.print_basic(
            self.depositStatus, format_data + "depositStatus")
        PrintBasic.print_basic(
            self.minDepositAmt, format_data + "minDepositAmount")
